...
import useMovieCastController from './MovieCastController'
...
const MovieCast = () => {
    const { movieCastDetails, movieDetails, isDataLoading } = useMovieCastController();
                    ...
                    <div className='flex flex-col gap-10 w-3/4 pt-10 z-10'>
                        ...
                        <div className='flex flex-col gap-5'>
                            ...
                            <div className='grid grid-cols-5 gap-5'>
                                {movieCastDetails?.cast.map(person => <CastFullCard key={person.id} data={person} />)}
                            </div>
                        </div>
